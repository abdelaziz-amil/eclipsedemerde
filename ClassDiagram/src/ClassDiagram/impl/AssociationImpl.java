...
public class AssociationImpl extends NamedElementImpl implements Association {
	...
	public EList<AssociationEnd> getEnds() {
		if (ends == null) {
			ends = new EObjectContainmentWithInverseEList<AssociationEnd>(AssociationEnd.class, this, ClassDiagramPackage.ASSOCIATION__ENDS, ClassDiagramPackage.ASSOCIATION_END__ASSOCIATION);
		}
		return ends;
	}
